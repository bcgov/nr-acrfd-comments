      ...
      describe('when a decision is cached', () => {
        beforeEach(async(() => {
          ...
          apiSpy.getDecisionByAppId.and.returnValues(
            ...
            throwError(
              Error('Was not expecting ApiService.getDecisionByAppId to be called more than once.'),
            ),
          )
      ...
      describe('when a decision is cached', () => {
        beforeEach(async(() => {
          ...
          apiSpy.getDecision.and.returnValues(
            ...
            throwError(
              new Error('Was not expecting ApiService.getDecision to be called more than once.'),
            ),
          )
