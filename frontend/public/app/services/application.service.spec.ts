...
describe('ApplicationService', () => {
  beforeEach(() => {
    ...
    const commentPeriodServiceSpy = spyOn(
      TestBed.get(CommentPeriodService),
  ...
  describe('getById()', () => {
    ...
    describe('when an application has been cached', () => {
      const cachedApplication = new Application({
        _id: 'AAAA',
        description: 'Old outdated application',
      })
      beforeEach(() => {
  ...
  describe('getStatusStringLong()', () => {
    ...
    it('with status ABANDONED and reason AMENDMENT APPROVED - APPLICATION it returns "Decision: Approved ..."', () => {
      application = new Application({
        status: 'ABANDONED',
        reason: 'AMENDMENT APPROVED - APPLICATION',
      })
    ...
    it('with status APPLICATION REVIEW COMPLETE it returns "Application Review Complete - Decision Pending"', () => {
      ...
      expect(service.getStatusStringLong(application)).toBe(
