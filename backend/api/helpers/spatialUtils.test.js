...
describe('SpacialUtils', () => {
  describe('getGeometryArray', () => {
    ...
    describe('success', () => {
      ...
      beforeAll(() => {
        convertWKTToGeoJsonSpy = jest
          .spyOn(SpacialUtils, 'convertWKTToGeoJson')
          .mockImplementation(() => {
            return 321
          })
        convertGeoJSONToEPSG3005Spy = jest
          .spyOn(SpacialUtils, 'convertGeoJSONToEPSG3005')
          .mockImplementation()
  ...
  describe('convertWKTToGeoJson', () => {
    describe('error', () => {
      ...
      it('throws an error if wktGeometry is not valid wkt (well-knwon text) format', () => {
        expect(() => SpacialUtils.convertWKTToGeoJson('INVALID((0 0, a b c d, 0))')).toThrow(
