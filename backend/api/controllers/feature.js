...
exports.publicGet = function (args, res, next) {
        ...
        query = {
          geometry: {
            $geoIntersects: {
              $geometry: {
                type: 'Polygon',
                coordinates: JSON.parse(args.swagger.params.coordinates.value),
              },
            },
          },
        }
  ...
  if (args.swagger.params.applicationId && args.swagger.params.applicationId.value !== undefined) {
    _.assignIn(query, {
      applicationID: new mongoose.Types.ObjectId(args.swagger.params.applicationId.value),
    })
  }
  if (args.swagger.params.tantalisId && args.swagger.params.tantalisId.value !== undefined) {
    _.assignIn(query, {
      'properties.DISPOSITION_TRANSACTION_SID': args.swagger.params.tantalisId.value,
    })
  }
...
exports.protectedDelete = function (args, res, next) {
  ...
  if (args.swagger.params.featureId) {
    ...
    args.swagger.params.applicationID &&
    args.swagger.params.applicationID.value !== undefined
  ) {
    _.assignIn(query, {
      applicationID: new mongoose.Types.ObjectId(args.swagger.params.applicationID.value),
    })
