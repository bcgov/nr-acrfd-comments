    ...
    setupFeatures().then((documents) => {
      request(app)
        ...
        .then((response) => {
          ...
          let firstFeature = _.find(response.body, {
            applicationID: specialApplicationId.toString(),
          })
          ...
          let secondFeature = _.find(response.body, {
            applicationID: vanillaApplicationId.toString(),
          })
          ...
          let secretFeature = _.find(response.body, {
            applicationID: topSecretApplicationId.toString(),
          })
